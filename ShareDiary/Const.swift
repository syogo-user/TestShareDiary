...
struct Const {
    ...
    static let color  = [
        ...
        ["startColor":UIColor(red:0/255,green:111/255,blue:111/255,alpha:1.0).cgColor,
         "endColor":UIColor(red:235/255,green:228/255,blue:233/255,alpha:1.0).cgColor,
        ],
        ["startColor":UIColor(red:35/255,green:228/255,blue:133/255,alpha:1.0).cgColor,
         "endColor":UIColor(red:115/255,green:228/255,blue:213/255,alpha:1.0).cgColor,
        ],
        ["startColor":UIColor(red:0/255,green:0/255,blue:0/255,alpha:1.0).cgColor,
         "endColor":UIColor(red:0/255,green:0/255,blue:0/255,alpha:1.0).cgColor,
        ],
        ["startColor":UIColor(red:235/255,green:228/255,blue:233/255,alpha:1.0).cgColor,
         "endColor":UIColor(red:55/255,green:199/255,blue:133/255,alpha:1.0).cgColor,
        ],
        ...
        ["startColor":UIColor(red:235/255,green:211/255,blue:123/255,alpha:1.0).cgColor,
