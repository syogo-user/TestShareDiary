...
struct Const {
    ...
    static let color  = [
        ...
        ["startColor":UIColor(red:249/255,green:212/255,blue:35/255,alpha:0.3).cgColor,
         "endColor":UIColor(red:248/255,green:54/255,blue:0/255,alpha:0.3).cgColor,
        ],
        ["startColor":UIColor(red:0/255,green:111/255,blue:111/255,alpha:0.3).cgColor,
        ...
        ["startColor":UIColor(red:0/255,green:0/255,blue:0/255,alpha:1).cgColor,
         "endColor":UIColor(red:0/255,green:0/255,blue:0/255,alpha:1).cgColor,
        ],
